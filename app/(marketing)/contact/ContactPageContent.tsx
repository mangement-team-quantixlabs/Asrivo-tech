              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
                    ...
                    <input id="name" name="name" type="text" required className={inputClass} placeholder="Shyam" />
                  </div>
                  <div>
                    <label htmlFor="email" className="mb-1.5 block text-sm font-medium text-brand-gray-700">Work Email *</label>
                    <input id="email" name="email" type="email" required className={inputClass} placeholder="shyam@gmail.com" />
                  </div>
                </div>
                <div className="grid gap-5 sm:grid-cols-2">
                  <div>
