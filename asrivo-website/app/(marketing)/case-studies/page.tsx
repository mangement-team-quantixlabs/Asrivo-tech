...
const caseStudies = [
  { title: "AI-Powered Fraud Detection for Global Banking Platform", client: "Major European Bank", stat: "94%", statLabel: "Fraud detection rate", industry: "Banking & Finance", href: "/case-studies/ai-fraud-detection" },
  { title: "Cloud Migration & Modernization for Healthcare Provider", client: "Leading US Health Network", stat: "60%", statLabel: "Infrastructure cost reduction", industry: "Healthcare", href: "/case-studies/healthcare-cloud-migration" },
  { title: "Smart Factory IoT Platform for Manufacturing Giant", client: "Fortune 500 Manufacturer", stat: "3x", statLabel: "Operational efficiency gain", industry: "Manufacturing", href: "/case-studies/smart-factory-iot" },
